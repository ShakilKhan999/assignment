                                      ...
                                      Obx(() => Column(
                                            ...
                                            children: [
                                              SizedBox(
                                                width: 170.w,
                                                child: Text(
                                                  'First Name: ${userController.UserData[0].data[0].fullName.toString().contains(' ') ? userController.UserData[0].data[0].fullName.toString().split(' ')[0] : userController.UserData[0].data[0].fullName.toString()}',
                                                  overflow:
                                              ...
                                              SizedBox(
                                                width: 170.w,
                                                child: Text(
                                                  'Last Name: ${userController.UserData[0].data[0].fullName.toString().contains(' ') ? userController.UserData[0].data[0].fullName.toString().split(' ')[1] : userController.UserData[0].data[0].fullName.toString()}',
                                                  overflow:
                                                      TextOverflow.ellipsis,
                                                  style: TextStyle(
                                                      fontSize: 15.sp,
